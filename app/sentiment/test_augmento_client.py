...
class TestAugmentoClient:
    def test_get_sentiments(self):
        ...
        sentiments = client.get_sentiment_for_dates(
            start=datetime(year=2020, month=6, day=1),
            end=datetime(year=2020, month=6, day=3),
        )
        expected1 = Sentiment(
            num_positive=296, num_negative=78, date=datetime(year=2020, month=6, day=1)
        )
        expected2 = Sentiment(
            num_positive=364, num_negative=126, date=datetime(year=2020, month=6, day=2)
        )
